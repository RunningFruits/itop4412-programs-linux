...
#ifdef CONFIG_TIMER_LIST_CTL
struct platform_device s3c_device_timer_list_ctl = {
        .name   = "timer_list",
        .id             = -1,
};
#endif
...
#ifdef CONFIG_3LADC_CTL
struct platform_device s3c_device_3ladc_ctl = {
        .name                   = "3ladc",
        .id                             = -1,
};
#endif
